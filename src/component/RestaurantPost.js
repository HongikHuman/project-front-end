            ...
            if(idx === 0) {
                result.push(
                    <ReviewBox>
                        ...
                        <Review reviewinfos={sortedReview[idx]} />
                    </ReviewBox>
                )
            }
            else if(idx === 1) {
                result.push(
                    <ReviewBox>
                        <Crown><RiVipCrownFill size='30px' color='silver'/></Crown>
                        <Review reviewinfos={sortedReview[idx]} />
                    </ReviewBox>
                )
            }
                ...
                result.push(
                    <ReviewBox>
                        <Crown><RiVipCrownFill size='30px' color='rgb(175, 117, 49)'/></Crown>
                        <Review reviewinfos={sortedReview[idx]} />
                    </ReviewBox>
                )
            }
